...
// End Cross Module References
	...
	UClass* Z_Construct_UClass_AFPSObjectiveActor()
	{
		...
		if (!OuterClass)
		{
			...
			static const UE4CodeGen_Private::FMetaDataPairParam NewProp_PickupFX_MetaData[] = {
				{ "Category", "Effects" },
				{ "ModuleRelativePath", "Public/FPSObjectiveActor.h" },
				{ "ToolTip", "Instantiate the particle effect, its editable in blueprints under the category effects" },
			};
#endif
			...
			static const UE4CodeGen_Private::FMetaDataPairParam NewProp_SphereComp_MetaData[] = {
				...
				{ "EditInline", "true" },
				{ "ModuleRelativePath", "Public/FPSObjectiveActor.h" },
				{ "ToolTip", "Instantiate the Sphere components" },
			};
#endif
			...
			static const UE4CodeGen_Private::FMetaDataPairParam NewProp_MeshComp_MetaData[] = {
				...
				{ "EditInline", "true" },
				{ "ModuleRelativePath", "Public/FPSObjectiveActor.h" },
				{ "ToolTip", "Instantiate the mesh components" },
			};
#endif
	...
	IMPLEMENT_CLASS(AFPSObjectiveActor, 809274040);
