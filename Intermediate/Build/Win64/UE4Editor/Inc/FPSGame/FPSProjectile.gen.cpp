...
// End Cross Module References
	...
	UClass* Z_Construct_UClass_AFPSProjectile()
	{
		...
		if (!OuterClass)
		{
...
#endif
#if WITH_METADATA
			static const UE4CodeGen_Private::FMetaDataPairParam NewProp_ExplsionEffect_MetaData[] = {
				{ "Category", "FX" },
				{ "ModuleRelativePath", "Public/FPSProjectile.h" },
				{ "ToolTip", "Projectile particle effect" },
			};
#endif
			static const UE4CodeGen_Private::FObjectPropertyParams NewProp_ExplsionEffect = { UE4CodeGen_Private::EPropertyClass::Object, "ExplsionEffect", RF_Public|RF_Transient|RF_MarkAsNative, 0x0020080000010001, 1, nullptr, STRUCT_OFFSET(AFPSProjectile, ExplsionEffect), Z_Construct_UClass_UParticleSystem_NoRegister, METADATA_PARAMS(NewProp_ExplsionEffect_MetaData, ARRAY_COUNT(NewProp_ExplsionEffect_MetaData)) };
#if WITH_METADATA
			...
			static const UE4CodeGen_Private::FPropertyParamsBase* const PropPointers[] = {
				(const UE4CodeGen_Private::FPropertyParamsBase*)&NewProp_ExplsionEffect,
	...
	IMPLEMENT_CLASS(AFPSProjectile, 4246615920);
