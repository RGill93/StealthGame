...
// End Cross Module References
	...
	UFunction* Z_Construct_UFunction_AFPSGameMode_OnMissionCompleted()
	{
		...
		if (!ReturnFunction)
		{
			...
			static const UE4CodeGen_Private::FMetaDataPairParam Function_MetaDataParams[] = {
				...
				{ "ToolTip", "Exposing our pawn character to blueprint\n       *@param takes in the FPSCharacter" },
			};
#endif
	...
	UClass* Z_Construct_UClass_AFPSGameMode()
	{
		...
		if (!OuterClass)
		{
			...
			static const FClassFunctionLinkInfo FuncInfo[] = {
				{ &Z_Construct_UFunction_AFPSGameMode_OnMissionCompleted, "OnMissionCompleted" }, // 273380090
			};
#if WITH_METADATA
			...
			static const UE4CodeGen_Private::FMetaDataPairParam NewProp_SpectatingViewpointClass_MetaData[] = {
				{ "Category", "Spectating" },
				{ "ModuleRelativePath", "Public/FPSGameMode.h" },
				{ "ToolTip", "Creating an instance of the spectator class in the editor" },
			};
#endif
	...
	IMPLEMENT_CLASS(AFPSGameMode, 1550766198);
