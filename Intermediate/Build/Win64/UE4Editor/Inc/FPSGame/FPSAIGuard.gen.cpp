...
// End Cross Module References
	...
	void AFPSAIGuard::StaticRegisterNativesAFPSAIGuard()
	{
		...
		static const FNameNativePtrPair Funcs[] = {
			...
			{ "OnRep_GuardState", (Native)&AFPSAIGuard::execOnRep_GuardState },
	...
	UFunction* Z_Construct_UFunction_AFPSAIGuard_OnNoiseHeard()
	{
		...
		if (!ReturnFunction)
		{
			...
			static const UE4CodeGen_Private::FMetaDataPairParam Function_MetaDataParams[] = {
				{ "ModuleRelativePath", "Public/FPSAIGuard.h" },
				{ "ToolTip", "A function for the Noise being heard by The AI guard" },
			};
#endif
	...
	UFunction* Z_Construct_UFunction_AFPSAIGuard_OnPawnSeen()
	{
		...
		if (!ReturnFunction)
		{
			...
			static const UE4CodeGen_Private::FMetaDataPairParam Function_MetaDataParams[] = {
				{ "ModuleRelativePath", "Public/FPSAIGuard.h" },
				{ "ToolTip", "Binds to the event OnPawnSeen" },
			};
#endif
	...
	UClass* Z_Construct_UClass_AFPSAIGuard()
	{
		...
		if (!OuterClass)
		{
			...
			static const FClassFunctionLinkInfo FuncInfo[] = {
				{ &Z_Construct_UFunction_AFPSAIGuard_OnNoiseHeard, "OnNoiseHeard" }, // 2129935176
				{ &Z_Construct_UFunction_AFPSAIGuard_OnPawnSeen, "OnPawnSeen" }, // 3283539097
				...
				{ &Z_Construct_UFunction_AFPSAIGuard_ResetOrientation, "ResetOrientation" }, // 841228546
			};
#if WITH_METADATA
	...
	IMPLEMENT_CLASS(AFPSAIGuard, 4065037328);
